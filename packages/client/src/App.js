...
function App() {
  ...
  // コントラクトアドレスを記載
  const daiTokenAddress = '0xde56ac3eb88dABAE9844b2bf05aa497325FF14e6';
  const dappTokenAddress = '0xd92F02b5abA3f971e35a3Ebde051CF8Dd7C60269';
  const tokenfarmAddress = '0xe733806182d96E44f8c56d2B879A43885216f2ea';

  //ウォレットアドレス(コントラクトの保持者)を記載
  const walletAddress = '0xD16c03C75EfABC58C209Ca7877c17b9d23C389e7';
